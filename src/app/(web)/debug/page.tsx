    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 dark:from-gray-900 dark:to-gray-800 p-8">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-3xl font-bold mb-8 text-gray-800 dark:text-white">Authentication Debug</h1>

                {/* Session Status */}
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 mb-6 shadow-lg">
                    <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Session Status</h2>
                    ...
                    {session ? (
                        ...
                        <div>
                            <p className="text-gray-600 dark:text-gray-300 mb-4">Not signed in</p>
                            <button
                                onClick={() => signIn()}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 mb-6 shadow-lg">
                    <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Test Sanity Connection</h2>
                    <button
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 mb-6 shadow-lg">
                    <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Environment Check</h2>
                    <div className="space-y-2 text-sm">
                        ...
                        <p><strong>GITHUB_CLIENT_ID:</strong> {process.env.NEXT_PUBLIC_GITHUB_CLIENT_ID ? "Set" : "Not set"}</p>

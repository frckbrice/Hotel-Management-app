...
import { FaPhone, FaEnvelope, FaMapMarkerAlt, FaClock, FaFacebook, FaTwitter, FaInstagram, FaLinkedin, FaPaperPlane, FaCheckCircle, FaMap } from "react-icons/fa";
                    ...
                    <div className="text-center">
                        ...
                        <div className="mt-3 sm:mt-4 p-2 sm:p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <p className="text-xs text-gray-600 dark:text-gray-400 text-justify mb-1 sm:mb-2">
                                Interactive map temporarily unavailable due to API key expiration.
                                Please contact us for directions or visit our location at the address above.
                            </p>
            ...
            <div className="relative h-60 sm:h-72 md:h-80 bg-gradient-to-r from-green-600 via-green-700 to-green-800 overflow-hidden">
                ...
                <div className="relative z-10 flex items-center justify-center h-full">
                    <div className="text-center text-white max-w-4xl px-4">
                        ...
                        <p className="text-lg sm:text-xl md:text-2xl opacity-90 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                            We&apos;d love to hear from you
                        </p>
                        <div className="mt-6 md:mt-8 flex justify-center space-x-2 md:space-x-4 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="absolute bottom-0 left-0 right-0">
                    <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-16">
                        <path d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z" opacity=".25" className="fill-green-50 dark:fill-gray-900"></path>
                        <path d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.07,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,103.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.05c59.73-5.85,113.28,22.88,168.9,38.84,30.2,8.66,59,6.17,87.09-7.5,22.43-10.89,48-26.93,60.65-49.24V0Z" opacity=".5" className="fill-green-50 dark:fill-gray-900"></path>
                        <path d="M0,0V5.63C149.93,59,314.09,71.32,475.83,42.57c43-7.64,84.23-20.12,127.61-26.46,59-8.63,112.48,12.24,165.56,35.4C827.93,77.22,886,95.24,951.2,90c86.53-7,172.46-45.71,248.8-84.81V0Z" className="fill-green-50 dark:fill-gray-900"></path>
                    </svg>
                </div>
            </div>
                                ...
                                <form className="space-y-6 sm:space-y-8" onSubmit={handleSubmit}>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                        <div className="group/input">
                                            <label htmlFor="firstName" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 sm:mb-3 group-focus-within/input:text-green-600 transition-colors">
                                                First Name
                                            </label>
                                        ...
                                        <div className="group/input">
                                            <label htmlFor="lastName" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 sm:mb-3 group-focus-within/input:text-green-600 transition-colors">
                                                Last Name
                                            </label>
                                            <div className="relative">
                                                <input
                                    ...
                                    <div className="group/input">
                                        <label htmlFor="email" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 sm:mb-3 group-focus-within/input:text-green-600 transition-colors">
                                            Email Address
                                        </label>
                                        <div className="relative">
                                            <input
                                    ...
                                    <div className="group/input">
                                        <label htmlFor="phone" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 sm:mb-3 group-focus-within/input:text-green-600 transition-colors">
                                            Phone Number
                                        </label>
                                        <div className="relative">
                                            <input
                                    ...
                                    <div className="group/input">
                                        <label htmlFor="subject" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 sm:mb-3 group-focus-within/input:text-green-600 transition-colors">
                                            Subject
                                        </label>
                                        <div className="relative">
                                            <select
                                    ...
                                    <div className="group/input">
                                        <label htmlFor="message" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 sm:mb-3 group-focus-within/input:text-green-600 transition-colors">
                                            Message
                                        </label>
                                        <div className="relative">
                                            <textarea
                        ...
                        <div className="group bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 dark:border-gray-700/20 hover:shadow-3xl transition-all duration-500 hover:-translate-y-1">
                            ...
                            <div className="space-y-8">
                                {[
                                    ...
                                    <div key={index} className="group/item flex items-start space-x-4 sm:space-x-6 p-3 sm:p-4 rounded-2xl hover:bg-green-50/50 dark:hover:bg-green-900/10 transition-all duration-300">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="space-y-1">
                                                {item.title === "Portfolio" ? (
                                                    ...
                                                    >
                                                        Check my work
                                                        <svg className="ml-1 w-3 h-3 group-hover/link:translate-x-1 group-hover/link:-translate-y-1 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                                                            <path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd" />
                                                        </svg>
                                                    </a>
                                                ) : (
                                                    item.content.map((line, i) => (
                                                        <p key={i} className="text-gray-600 dark:text-gray-300 leading-relaxed text-sm sm:text-base break-words">
                                                            {line}
                                                        </p>
                                                    ))
                                                )}
                        ...
                        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 dark:border-gray-700/20 hover:shadow-3xl transition-all duration-500">
                            ...
                            <div className="flex justify-center space-x-6">
                                {[
                                    ...
                                    { icon: FaTwitter, color: "from-sky-500 to-sky-600", hoverColor: "hover:from-sky-600 hover:to-sky-700" },
                                    { icon: FaInstagram, color: "from-pink-600 to-pink-700", hoverColor: "hover:from-pink-700 hover:to-pink-800" },
                                    { icon: FaLinkedin, color: "from-blue-700 to-blue-800", hoverColor: "hover:from-blue-800 hover:to-blue-900" }
                                ].map((social, index) => (
                                    <a
                                        key={index}
                                        href="#"
                        ...
                        <div className="relative bg-gradient-to-br from-red-300 via-red-400 to-red-400 rounded-3xl shadow-2xl p-8 text-white overflow-hidden group hover:shadow-3xl transition-all duration-500">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between mb-6">
                                    <h3 className="text-2xl font-bold font-heading">Emergency Contact</h3>
                                    <div className="w-4 h-4 bg-red-200 rounded-full animate-pulse"></div>
                                </div>
                                <p className="mb-6 opacity-90 text-lg">For urgent matters outside business hours</p>
                                <div className="space-y-4">
                                    <div className="flex items-center space-x-3 sm:space-x-4 p-3 bg-white/10 rounded-xl backdrop-blur-sm">
                                        ...
                                        <span className="font-semibold text-sm sm:text-base break-words">Emergency: +237 999 888 777</span>
                                    </div>
                                    <div className="flex items-center space-x-3 sm:space-x-4 p-3 bg-white/10 rounded-xl backdrop-blur-sm">
                                        <FaEnvelope className="text-red-200 text-lg sm:text-xl flex-shrink-0" />
                                        <span className="font-semibold text-sm sm:text-base break-words">emergency@luxuryhotel.com</span>
                                    </div>
                                </div>
                            </div>
                        </div>

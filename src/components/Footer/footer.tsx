...
const Footer = (props: Props) => {
  ...
  const footerLinks = {
    ...
    social: [
      { name: "Facebook", href: "#", icon: BsFacebook, color: "hover:text-blue-600" },
      { name: "Twitter", href: "#", icon: BsTwitter, color: "hover:text-sky-500" },
      { name: "Instagram", href: "#", icon: BsInstagram, color: "hover:text-pink-600" },
      { name: "LinkedIn", href: "#", icon: BsLinkedin, color: "hover:text-blue-700" }
    ]
  };
      ...
      <div className="container mx-auto px-4 py-12 sm:py-16 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed text-justify">
            Experience luxury and comfort at its finest. Your perfect getaway awaits with world-class amenities and exceptional service.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-8">
              ...
              <h4 className="font-bold text-xl text-gray-800 dark:text-white">Contact</h4>
            </div>
            ...
            <div className="space-y-6">
              <div className="group flex items-start space-x-4 p-4 rounded-xl hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">123 Road, Avom</p>
                </div>
              </div>
              ...
              <div className="group flex items-start space-x-4 p-4 rounded-xl hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">674-852-304</p>
                </div>
              </div>
          ...
          {/* Newsletter & Social */}
          <div className="lg:col-span-1">
            <h4 className="font-bold text-xl text-gray-800 dark:text-white mb-8">Stay Connected</h4>
            ...
            {/* Social Media */}
            <div>
              <p className="text-gray-600 dark:text-gray-400 mb-4 text-sm">Follow us on social media</p>

...
export const heading1 = (
  <>
    {" "}
    <h1 className="font-heading mb-4 lg:mb-6 text-3xl sm:text-4xl lg:text-5xl xl:text-6xl"> Explore Our Exquisite Hotel</h1>
    ...
    <button className="btn-primary text-sm sm:text-base px-6 py-3 lg:px-8 lg:py-4"> Get Started</button>
  </>
);

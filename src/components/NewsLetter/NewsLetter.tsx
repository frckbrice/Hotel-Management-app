  ...
  return (
    <section className="container mx-auto px-4">
      <form className="bg-gradient-to-r from-green-600 to-green-800 text-white px-4 sm:px-6 lg:px-8 rounded-xl md:rounded-[30px] flex flex-col justify-center items-center py-8 md:py-16 lg:py-24 shadow-xl mt-10">
        ...
        <h6 className="font-semibold font-medium text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center w-full pt-8 md:pt-12 gap-4 sm:gap-0">
          ...
          />
          <button type="button" className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-gray-900 font-semibold px-6 py-3 md:py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl text-sm md:text-base">
            Subscribe
          </button>
        </div>
      </form>

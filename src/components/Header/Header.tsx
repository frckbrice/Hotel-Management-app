      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            ...
            >
              <span
                className="font-black bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-transparent bg-clip-text text-4xl"
              >
                HotelMT
              </span>
              <div className="absolute -bottom-1 left-0 w-0 h-0.5" style={{ background: 'linear-gradient(45deg, hsl(var(--primary)), hsl(var(--accent)))' }}></div>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative group">
              {session?.user ? (
                ...
                >
                  {session.user.image ? (
                    <div className="relative w-10 h-10 rounded-full overflow-hidden ring-2 ring-transparent transition-all duration-300" style={{ '--tw-ring-color': 'hsl(var(--primary))' } as any}>
                      <Image
            ...
            >
              {isMobileMenuOpen ? (
                ...
                <FaBars className="text-gray-700 dark:text-gray-300" size={24} />
              )}
            </button>
          </div>
        </div>
